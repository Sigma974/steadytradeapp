...
const FRAUNCES_STACK = 'var(--font-fraunces), "Cormorant Garamond", Georgia, serif';
const INTER_TIGHT_STACK = 'var(--font-inter-tight), system-ui, sans-serif';
...
const Headline = ({ children, className = "" }) => (
  <h2
    className={`text-[40px] leading-[1.05] tracking-[-0.02em] text-white md:text-[56px] ${className}`}
    style={{ fontFamily: FRAUNCES_STACK }}
  >
    {children}
  </h2>
);
...
const Nav = ({ signinHref, signupHref }) => {
            ...
            <div className="grid grid-cols-4 gap-3">
              {[
                ...
                >
                  ...
                  <div className="mt-1 text-[20px] tracking-tight text-white" style={{ fontFamily: FRAUNCES_STACK }}>
                    {s.value}
                  </div>
                  <div
...
const Hero = ({ signupHref }) => (
  <section className="relative overflow-hidden pb-24 pt-36 md:pb-32 md:pt-44">
    ...
    <Container className="relative">
      ...
      >
        {/* TODO: link to a "what's new" / changelog page once it exists */}
        <a
          href="#"
        ...
        <div className="mt-9 flex flex-col items-center gap-3 sm:flex-row">
          ...
          {/* TODO: link to demo video / product tour once recorded */}
          <a
            href="#"
    ...
    <section id="psychology" className="relative overflow-hidden py-28 md:py-36">
      ...
      <Container className="relative">
        ...
        <div className="mt-16 grid gap-px overflow-hidden rounded-2xl border border-white/[0.07] bg-white/[0.04] md:grid-cols-4">
          {items.map((item, i) => (
            ...
            >
              ...
              <div
                className="mt-4 text-[36px] tracking-tight text-white md:text-[42px]"
                style={{ fontFamily: FRAUNCES_STACK }}
              >
                {item.val}
              </div>
        ...
        <div className="mt-12 flex flex-col items-center gap-6 md:flex-row md:justify-center">
          ...
          {/* TODO: link to manifesto page once written */}
          <a
            href="#"
...
const PricingSection = ({ signupHref }) => {
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="mt-7 flex items-baseline gap-1.5">
                  <span
                    className="text-[52px] leading-none tracking-tight text-white"
                    style={{ fontFamily: FRAUNCES_STACK }}
                  >
      ...
      <div className="grid gap-12 md:grid-cols-12">
        <div className="md:col-span-5">
          ...
          <div className="mt-7 flex gap-3">
            {/* TODO: replace # with real social URLs (Twitter, Github, contact email) */}
        ...
        <div className="grid grid-cols-2 gap-10 md:col-span-7 md:grid-cols-3">
          {/* TODO: every footer link below is a placeholder — create the corresponding pages
                    and add them to middleware.ts allowedPaths before wiring real routes */}
          {[
            {
              title: "Product",
...
export default function SteadyLanding() {
  ...
  const signupHref = locale === "fr" ? "/fr/signup" : "/signup";

  return (
    <div
      className="relative min-h-screen bg-[#070707] text-white antialiased selection:bg-emerald-300/30 selection:text-white"
      style={{ fontFamily: INTER_TIGHT_STACK }}
    >
      <Nav signinHref={signinHref} signupHref={signupHref} />
      <main>
